...
{JOptionPane.showMessageDialog(null, "you should enter a numeric value in the field whose name is "+n);}
boolean flag = false;
       Book Array[] = librarian.getListOfBooks();
        ...
        if (!flag) {
            ...
            JOptionPane.showMessageDialog(null, "the books with id=" + Id + "has been succesfully added");
